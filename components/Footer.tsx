  ...
  return (
    <footer className="text-center h-16 sm:h-20 w-full sm:pt-2 pt-4 border-t mt-10 sm:gap-0 gap-4 flex sm:flex-row flex-col justify-between items-center px-3 space-y-2 sm:mb-0 mb-3">
      <div className="dark:text-zinc-100">
        <CheckIcon className="inline mr-1 dark:text-zinc-100" />
      ...
      <div className="flex space-x-3 sm:space-x-4">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700 dark:fill-zinc-300 dark:group-hover:fill-zinc-100"
          >
